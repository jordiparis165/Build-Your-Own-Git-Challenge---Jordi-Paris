...
fn main() {
    ...
    match args[1].as_str() {
        ...
        "commit-tree" => {
            ...
            let author = "Jordi Paris <jordi.paris@edu.devinci.fr>";
        ...
        "clone" => {
            ...
            fn parse_pack_and_store(
                ...
                for _ in 0..num_objects {
                    ...
                    // on ne gère pas les deltas dans ce clone minimal
                    match obj_type {
                    ...
                    // décompression zlib à partir de i
            ...
            fn clone_repo(url: &str, dir: &str) -> Result<(), Box<dyn Error>> {
                ...
                // 4. Construire requête git-upload-pack
